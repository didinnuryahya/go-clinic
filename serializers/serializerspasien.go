...
type PasienUserSerializer struct {
	C *gin.Context
	[]models.PasienModel
}

func (s *PasienUserSerializer) Response() pasiens.HistoryPasienResponse {
	response := serializers.PasienSerializer{s.C, s.ArticleUserModel.UserModel}
